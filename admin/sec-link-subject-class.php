...
//now to edit the product	
	if (empty($errors)){
        ...
        $notlinkquery = mysqli_query($connect, "SELECT secondary_class_subjects_id FROM secondary_class_subjects WHERE 	secondary_class_id_class = '".$class."' AND secondary_subject_id_subject = '".$subject."'") or die(db_conn_error);
        
        if(mysqli_num_rows($notlinkquery) == 0){

            mysqli_query($connect, "INSERT INTO secondary_class_subjects (secondary_class_id_class, secondary_subject_id_subject) VALUES ('".$class."', '".$subject."')") or die(mysqli_error($connect));
...
<div class="col-12 grid-margin stretch-card">
   ...
   <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">The subject has already been added to a secondary school class</h4>
             ...
             <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php 
                    $subjectquery = mysqli_query($connect, "SELECT secondary_subjects_id, secondary_subjects_name FROM secondary_subject") or die(db_conn_error);
                    ...
                    ?>
                       ...
                       <?php        
                        ...
                        while($link = mysqli_fetch_array($subjectquery)){
                            echo '<option value="'.$link['secondary_subjects_id'].'">'.$link['secondary_subjects_name'].'</option>';
